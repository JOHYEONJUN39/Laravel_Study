                    ...
                    <div class="container px-5 mx-auto">
                      <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <div class="-m-2">
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              <label for="language" class="leading-7 text-sm text-gray-600">제목</label>
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              ...
                              <select name="age">
                                ...
                                <option value="1" @if($contact->age === 1) selected @endif >19세 미만</option>
                                <option value="2" @if($contact->age === 2) selected @endif>20세〜29세</option>
                                <option value="3" @if($contact->age === 3) selected @endif>30세〜39세</option>
                                <option value="4" @if($contact->age === 4) selected @endif>40세〜49세</option>
                                <option value="5" @if($contact->age === 5) selected @endif>50세〜59세</option>
                                <option value="6" @if($contact->age === 6) selected @endif>60세 이상</option>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="p-2 w-full">
                            <button class="flex  mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">변경</button>
                          </div>
                        </div>
                      </div>
                    </div>
